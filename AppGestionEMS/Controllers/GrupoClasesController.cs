...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreGrupo,MaxAlumGrupo")] GrupoClases grupoClases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreGrupo,MaxAlumGrupo")] GrupoClases grupoClases)
        {
            if (ModelState.IsValid)
            {

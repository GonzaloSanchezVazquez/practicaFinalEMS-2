...
namespace AppGestionEMS.Controllers
{
    ...
    public class AsignacionDocentesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.GrupoId = new SelectList(db.GrupoClases, "Id", "NombreGrupo");
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,UserId,GrupoId")] AsignacionDocentes asignacionDocentes)
        {
            ...
            ViewBag.CursoId = new SelectList(db.Cursos, "Id", "NombreCurso", asignacionDocentes.CursoId);
            ViewBag.GrupoId = new SelectList(db.GrupoClases, "Id", "NombreGrupo", asignacionDocentes.GrupoId);
